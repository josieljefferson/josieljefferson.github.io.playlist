...
def download_file(url, filename):
    ...
    try:
        ...
        print(f"❌ Falha ao baixar {filename}: {str(e)}")
        return False
...
def main():
    ...
    if all(results):
        print("✅ Todas as playlists foram atualizadas com sucesso!")
    else:
        print("⚠️ Algumas playlists falharam ao atualizar")
